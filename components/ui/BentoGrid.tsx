...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("amaharjan1032@gmail.com");
    setCopied(true);
  };
  ...
  return (
    <div
      className={cn(
        "row-span-1 overflow-hidden relative rounded-3xl border border-white/[0.1] group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none justify-between flex flex-col space-y-4",
        className
      )}
      style={{
